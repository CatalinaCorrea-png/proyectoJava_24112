...
//Se utiliza para asegurar la consistencia en la serialización 
// de la clase cuando se gestiona el estado de un servlet en un entorno distribuido.
...
//    a los métodos doGet(), doPost() cuando se realiza una solicitud al servlet.
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        // Obtener parametros de la solicitud
